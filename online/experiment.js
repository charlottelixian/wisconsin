...
const instructions = {
    ...
    pages: [
        ...
        `<p>${language.instruction.fourCards}</p><p>${language.instruction.newCard}</p><p>${language.instruction.clickCard}</p><br><img src="../images/instruction.png" style="width: 500px"/></p><p style="color: #f6f6f8">Placeholder</p>`,
        `<p>${language.instruction.rule}</p><p>${language.instruction2.ruleChange}</p><p>${language.instruction2.ruleChange2}</p><br><img src="../images/instruction.png" style="width: 500px"/><p>${language.instruction2.clickNext}</p>`,
    ],
...
function addTrials (targetCard) {
    return trial = {
        ...
        choices: ["../images/triangle_red_1.png", "../images/star_green_2.png", "../images/diamond_yellow_3.png", "../images/circle_blue_4.png"],
